                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-start">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" id="numeroFactura" name="numeroFactura"
                                            placeholder="Ingrese Numero Factura" autofocus>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="row justify-content-center my-1">
                                    <div class="col-2 text-right">
                                        <input type="submit" value="DESCARGAR" class="btn btn-sm"
                                ...
                                <div class="row justify-content-start">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" id="numeroFactura"
                                            name="numeroFactura" placeholder="Ingrese Numero Factura" autofocus>
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="date_field">Fecha Inicio:</label>
                                        <input type="date" name="inicio" id="date_field" class="form-control">
